...
char* ssid = "Hotspot Area"; //enter SSID
char* passphrase = "sekolahvokasimadiun"; // enter the password
...
String writeAPIKey = "M1YSEBYIGT0TVP3O";
...
void kirim_thingspeak(float suhu, float hum) {
  if (client.connect("api.thingspeak.com", 80)) {
    ...
    request_string += "key=";
    request_string += "M1YSEBYIGT0TVP3O";
    request_string += "&";
